...
public class ClockView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		System.err.println("Total instances of Color: " + c);
		String[] ids = TimeZone.getAvailableIDs();
		timezones = new Combo(parent, SWT.SIMPLE);
		timezones.setVisibleItemCount(2);
		for (String id : ids) {
			timezones.add(id);
		}
		timezones.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				int offset = tz == null ? 0 : (tz.getOffset(System.currentTimeMillis()) - dt.getOffset(System.currentTimeMillis())) / 3600;
